...
int ipp_get_printer_attributes(ipp_attribute **printer_attr, ipp_pstate_t printerstate)
{
    ...
    ippAddString(printer_attr, "printer-make-and-model", "PP "PROJECT_NAME" Series", IPP_TAG_PRINTER, IPP_TAG_TEXT);
    ...
    ippAddString(printer_attr, "printer-name", "PP "PROJECT_NAME" Series", IPP_TAG_PRINTER, IPP_TAG_NAME);
    ...
    ippAddString(printer_attr, "printer-uri-supported", "ipp://esp32-mdns.local:631/ipp/print", IPP_TAG_PRINTER, IPP_TAG_URI);
